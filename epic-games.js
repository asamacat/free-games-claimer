...
try {
  ...
  // Bolt: Optimized Playwright element attribute extraction
  // By using evaluateAll, we run this natively in the browser instead of N sequential Playwright IPC requests.
